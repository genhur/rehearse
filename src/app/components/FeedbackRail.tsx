          ...
          >
            <div className="p-6 space-y-8">
              ...
              <div style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: 24 }}>
                ...
                <p className="font-body text-r-text-secondary" style={{ fontSize: 16, lineHeight: 1.6 }}>
              ...
              <div className="bg-r-surface p-5" style={{ borderRadius: 'var(--r-radius-lg)', borderLeft: '3px solid var(--r-accent-purple)' }}>
                ...
                <p className="font-body text-r-text-primary" style={{ fontSize: 16, lineHeight: 1.6 }}>
                  {report.howYouCameAcross}
                </p>
                {audioAnalysis && (
                  <div className="mt-3 px-3 py-2 rounded-lg" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}>
                    <p className="font-body text-r-text-secondary" style={{ fontSize: 14 }}>
                ...
                <ul className="space-y-2">
                  {report.whatWorked.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      ...
                      <p className="font-body text-r-text-secondary" style={{ fontSize: 16, lineHeight: 1.6 }}>{item}</p>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="font-body text-r-text-secondary mb-2" style={{ fontSize: 14, fontWeight: 500 }}>What you said</p>
                    <p className="p-3 bg-r-surface rounded-lg font-body text-r-text-primary" style={{ fontSize: 16, lineHeight: 1.6 }}>
                      "{report.replayMoment.originalMoment}"
                    </p>
                  </div>

                  <div>
                    <p className="font-body text-r-text-secondary mb-2" style={{ fontSize: 14, fontWeight: 500 }}>How you likely sounded</p>
                    <p className="p-3 rounded-lg font-body" style={{ fontSize: 16, lineHeight: 1.6, backgroundColor: 'rgba(221,207,80,0.1)', border: '1px solid rgba(221,207,80,0.2)', color: 'var(--r-accent-yellow)' }}>
                      {report.replayMoment.howYouLikelySounded}
                    </p>
                  </div>

                  <div>
                    <p className="font-body text-r-text-secondary mb-2" style={{ fontSize: 14, fontWeight: 500 }}>How it may have landed</p>
                    <p className="p-3 bg-r-surface rounded-lg font-body text-r-text-secondary" style={{ fontSize: 16, lineHeight: 1.6 }}>
                      {report.replayMoment.howItMayHaveLanded}
                    </p>
                  </div>

                  <div>
                    <p className="font-body text-r-text-secondary mb-2" style={{ fontSize: 14, fontWeight: 500 }}>Stronger version</p>
                    <p className="p-3 rounded-lg font-body text-r-accent-mint font-medium" style={{ fontSize: 16, lineHeight: 1.6, backgroundColor: 'rgba(152,225,211,0.1)', border: '2px solid rgba(152,225,211,0.2)' }}>
                      "{report.replayMoment.strongerVersion}"
                    </p>
                  </div>

                  <div>
                    <p className="font-body text-r-text-secondary mb-2" style={{ fontSize: 14, fontWeight: 500 }}>Delivery tip</p>
                    <p className="p-3 rounded-lg font-body" style={{ fontSize: 16, lineHeight: 1.6, backgroundColor: 'rgba(62,91,242,0.1)', border: '1px solid rgba(62,91,242,0.2)', color: 'var(--r-accent-blue)' }}>
